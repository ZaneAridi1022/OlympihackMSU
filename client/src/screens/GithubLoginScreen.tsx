...
function GithubLoginScreen() {
    ...
    const [commitNum1, setCommitNum1] = useState(0);
    const [commitNum2, setCommitNum2] = useState(0);
    const [commitNum3, setCommitNum3] = useState(0);
